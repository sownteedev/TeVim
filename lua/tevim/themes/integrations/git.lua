...
return {
	...
	GitSignsChange = { fg = utils.mix(colors.red, utils.mix(colors.red, colors.green, 0.5), 0.5) },
	...
	DiffChange = { fg = utils.mix(colors.red, utils.mix(colors.red, colors.green, 0.5), 0.5) },
	DiffChangeDelete = { fg = colors.red },
	DiffModified = { fg = utils.mix(colors.red, utils.mix(colors.red, colors.green, 0.5), 0.5) },
